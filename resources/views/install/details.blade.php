              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" value="{{ env('APP_NAME', 'Sirius-IT-POS-2'); }}" placeholder="{{ env('APP_NAME', 'Sirius-IT-POS-2'); }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="APP_TITLE" class="form-control" id="app_title" value="{{ env('APP_NAME', 'Sirius-IT-POS-2'); }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="db_host" name="DB_HOST" required placeholder="localhost / 127.0.0.1" value="{{ $_SERVER['SERVER_NAME']; }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="db_database" name="DB_DATABASE" value="{{ strtolower(env('APP_NAME', 'Sirius-IT-POS-2')); }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" value="siriusitconsultancy@gmail.com" placeholder="siriusitconsultancy@gmail.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" value="{{ env('APP_NAME', 'Sirius-IT-POS-2'); }}" placeholder="{{ env('APP_NAME', 'Sirius-IT-POS-2'); }}">
                    </div>
                  </div>
